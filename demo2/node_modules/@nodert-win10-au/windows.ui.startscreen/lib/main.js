...
const npmScope = 'nodert-win10-au';

// This little trick makes Node.js Tools for VS load IntelliSense for the module
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_UI_StartScreen.d.js)'))) {
  module.exports = require('./NodeRT_Windows_UI_StartScreen.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Foundation', 'Windows.UI.Popups'];
